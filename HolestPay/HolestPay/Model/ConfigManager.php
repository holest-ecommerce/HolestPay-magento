...
use HolestPay\HolestPay\Api\ConfigManagerInterface;
...
class ConfigManager implements ConfigManagerInterface
{
    ...
    private const PATH_MERCHANT_UID = 'payment/holestpay/merchant_uid';
    ...
    public function getHPayConfig(): array
    {
        $conf = [
            ...
            'merchant_uid' => (string)$this->getValue(self::PATH_MERCHANT_UID),
    ...
    public function setHPayConfig(array $configData): void
    {
        $map = [
            ...
            'merchant_uid' => self::PATH_MERCHANT_UID,
